      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300">
            Calculate production units per different time periods based on cycle time and machine running hours
          </p>
        </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
            ...
            <div className="mb-6">
              ...
              <div className="space-y-3">
                ...
                >
                  <option value="">Select common values or enter custom below</option>
                  <option value="1">1 unit per cycle</option>
                  <option value="2">2 units per cycle</option>
                  <option value="4">4 units per cycle</option>
                  <option value="6">6 units per cycle</option>
                  <option value="8">8 units per cycle</option>
                  <option value="12">12 units per cycle</option>
                  <option value="16">16 units per cycle</option>
                  <option value="24">24 units per cycle</option>
                  <option value="32">32 units per cycle</option>
                  <option value="48">48 units per cycle</option>
                  <option value="72">72 units per cycle</option>
                </select>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setProductionUnits(e.target.value)}
                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-lg"
                    placeholder="Or enter custom number of units"
                  />
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                Choose from common values above or enter any custom value in the text field
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                <span className="font-medium">Units per Cycle:</span> {productionUnits || '0'}
              </p>
              <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                <span className="text-gray-700 dark:text-gray-300 font-medium">Units per Second</span>
              ...
              <div className="flex justify-between items-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                <span className="text-gray-700 dark:text-gray-300 font-medium">Units per Minute</span>
              ...
              <div className="flex justify-between items-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                <span className="text-gray-700 dark:text-gray-300 font-medium">Units per Hour</span>
                <span className="text-xl font-bold text-purple-600 dark:text-purple-400">
                  {formatNumber(results.unitsPerHour)}
                </span>
              </div>
              
              <div className="flex justify-between items-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg border-2 border-orange-200 dark:border-orange-700">
                <div className="flex flex-col">
                  <span className="text-gray-700 dark:text-gray-300 font-medium">Units per Day</span>
              ...
              <div className="flex justify-between items-center p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border-2 border-red-200 dark:border-red-700">
                <div className="flex flex-col">
                  <span className="text-gray-700 dark:text-gray-300 font-medium">Units per Week</span>
                  <span className="text-xs text-gray-500 dark:text-gray-400">
              ...
              <div className="flex justify-between items-center p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg border-2 border-indigo-200 dark:border-indigo-700">
                <div className="flex flex-col">
                  <span className="text-gray-700 dark:text-gray-300 font-medium">Units per Month</span>
                  <span className="text-xs text-gray-500 dark:text-gray-400">
        ...
        <div className="mt-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-sm text-gray-600 dark:text-gray-400">
            <div>
              <h4 className="font-medium text-gray-900 dark:text-white mb-2">Example 1: Assembly Line</h4>
              <p>Single shift production line:</p>
              <ul className="list-disc list-inside mt-1 space-y-1">
                <li>Cycle: 2 min 30 sec</li>
                <li>Units per cycle: 1</li>
                <li>Running hours: 8/day</li>
              </ul>
            </div>
            <div>
              <h4 className="font-medium text-gray-900 dark:text-white mb-2">Example 2: Batch Process</h4>
              <p>Double shift operation:</p>
              <ul className="list-disc list-inside mt-1 space-y-1">
                <li>Cycle: 4 hours</li>
                <li>Units per cycle: 500</li>
                <li>Running hours: 16/day</li>
              </ul>
            </div>
            <div>
              <h4 className="font-medium text-gray-900 dark:text-white mb-2">Example 3: Continuous Process</h4>
              <p>24/7 operation:</p>
              <ul className="list-disc list-inside mt-1 space-y-1">
